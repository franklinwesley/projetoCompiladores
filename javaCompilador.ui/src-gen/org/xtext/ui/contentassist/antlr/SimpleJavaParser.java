		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getExpression_auxAccess().getOpedadorAlternatives_0_2_0(), "rule__Expression_aux__OpedadorAlternatives_0_2_0");
					...
					put(grammarAccess.getExpression_auxAccess().getOpedadorAlternatives_0_4_2_0_0(), "rule__Expression_aux__OpedadorAlternatives_0_4_2_0_0");
					...
					put(grammarAccess.getExpression_auxAccess().getOpedadorAssignment_0_2(), "rule__Expression_aux__OpedadorAssignment_0_2");
					put(grammarAccess.getExpression_auxAccess().getOpedadorAssignment_0_3_0_1(), "rule__Expression_aux__OpedadorAssignment_0_3_0_1");
					put(grammarAccess.getExpression_auxAccess().getOpedadorAssignment_0_3_0_2(), "rule__Expression_aux__OpedadorAssignment_0_3_0_2");
					put(grammarAccess.getExpression_auxAccess().getOpedadorAssignment_0_3_0_3(), "rule__Expression_aux__OpedadorAssignment_0_3_0_3");
					put(grammarAccess.getExpression_auxAccess().getOpedadorAssignment_0_3_0_4(), "rule__Expression_aux__OpedadorAssignment_0_3_0_4");
					put(grammarAccess.getExpression_auxAccess().getOpedadorAssignment_0_3_0_5(), "rule__Expression_aux__OpedadorAssignment_0_3_0_5");
					put(grammarAccess.getExpression_auxAccess().getOpedadorAssignment_0_3_0_6(), "rule__Expression_aux__OpedadorAssignment_0_3_0_6");
					put(grammarAccess.getExpression_auxAccess().getOpedadorAssignment_0_3_0_7(), "rule__Expression_aux__OpedadorAssignment_0_3_0_7");
					put(grammarAccess.getExpression_auxAccess().getOpedadorAssignment_0_3_0_8(), "rule__Expression_aux__OpedadorAssignment_0_3_0_8");
					...
					put(grammarAccess.getExpression_auxAccess().getOpedadorAssignment_0_4_2_0(), "rule__Expression_aux__OpedadorAssignment_0_4_2_0");
					...
					put(grammarAccess.getMais_auxAccess().getOpedadorAssignment_0(), "rule__Mais_aux__OpedadorAssignment_0");
					put(grammarAccess.getMais_auxAccess().getOpedadorAssignment_1(), "rule__Mais_aux__OpedadorAssignment_1");
