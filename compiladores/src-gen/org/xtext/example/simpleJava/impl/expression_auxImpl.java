 ...
 * <ul>
 *   <li>{@link org.xtext.example.simpleJava.impl.expression_auxImpl#getParametros <em>Parametros</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.impl.expression_auxImpl#getExp <em>Exp</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.impl.expression_auxImpl#getOp <em>Op</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.impl.expression_auxImpl#getOperador <em>Operador</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.impl.expression_auxImpl#getExpressoes <em>Expressoes</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
