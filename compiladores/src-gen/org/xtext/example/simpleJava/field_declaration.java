 ...
 * <ul>
 *   <li>{@link org.xtext.example.simpleJava.field_declaration#getComentario <em>Comentario</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.field_declaration#getDeclaracaoMetodo <em>Declaracao Metodo</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.field_declaration#getDeclaracaoConstrutor <em>Declaracao Construtor</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.field_declaration#getDeclaracaoVariavel <em>Declaracao Variavel</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.field_declaration#getEstatico <em>Estatico</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.simpleJava.SimpleJavaPackage#getfield_declaration()
 * @model
 * @generated
 */
public interface field_declaration extends EObject
{
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getfield_declaration_Comentario()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.field_declaration#getComentario <em>Comentario</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getfield_declaration_DeclaracaoMetodo()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.field_declaration#getDeclaracaoMetodo <em>Declaracao Metodo</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getfield_declaration_DeclaracaoConstrutor()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.field_declaration#getDeclaracaoConstrutor <em>Declaracao Construtor</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getfield_declaration_DeclaracaoVariavel()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.field_declaration#getDeclaracaoVariavel <em>Declaracao Variavel</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getfield_declaration_Estatico()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.field_declaration#getEstatico <em>Estatico</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
