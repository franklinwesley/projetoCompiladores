 ...
 * <ul>
 *   <li>{@link org.xtext.example.simpleJava.while_statement#getExpressaoWhile <em>Expressao While</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.while_statement#getBlocoWhile <em>Bloco While</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.simpleJava.SimpleJavaPackage#getwhile_statement()
 * @model
 * @generated
 */
public interface while_statement extends EObject
{
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getwhile_statement_ExpressaoWhile()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.while_statement#getExpressaoWhile <em>Expressao While</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getwhile_statement_BlocoWhile()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.while_statement#getBlocoWhile <em>Bloco While</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
