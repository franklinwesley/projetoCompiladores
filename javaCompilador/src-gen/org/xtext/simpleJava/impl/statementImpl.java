 ...
 * <ul>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getDeclaracaoVariavel <em>Declaracao Variavel</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getExpressao <em>Expressao</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getBloco <em>Bloco</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getCorpoIf <em>Corpo If</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getCorpoDoWhile <em>Corpo Do While</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getCorpoWhile <em>Corpo While</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getCorpoFor <em>Corpo For</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getCorpoTryCatch <em>Corpo Try Catch</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getCorpoSwitchCase <em>Corpo Switch Case</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getExpressaoSynchronized <em>Expressao Synchronized</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getCorpoSynchronize <em>Corpo Synchronize</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getReturn <em>Return</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getExececao <em>Exececao</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getBreak <em>Break</em>}</li>
 *   <li>{@link org.xtext.simpleJava.impl.statementImpl#getContinue <em>Continue</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
