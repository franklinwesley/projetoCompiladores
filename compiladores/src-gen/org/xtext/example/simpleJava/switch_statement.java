 ...
 * <ul>
 *   <li>{@link org.xtext.example.simpleJava.switch_statement#getExpressaoSwitch <em>Expressao Switch</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.switch_statement#getExpressaoCases <em>Expressao Cases</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.switch_statement#getBlocoSwitch <em>Bloco Switch</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.simpleJava.SimpleJavaPackage#getswitch_statement()
 * @model
 * @generated
 */
public interface switch_statement extends EObject
{
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getswitch_statement_ExpressaoSwitch()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.switch_statement#getExpressaoSwitch <em>Expressao Switch</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getswitch_statement_ExpressaoCases()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getswitch_statement_BlocoSwitch()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.switch_statement#getBlocoSwitch <em>Bloco Switch</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
