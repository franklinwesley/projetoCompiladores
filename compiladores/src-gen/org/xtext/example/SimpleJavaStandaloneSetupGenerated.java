...
public class SimpleJavaStandaloneSetupGenerated implements ISetup {
	...
	public Injector createInjector() {
		return Guice.createInjector(new org.xtext.example.SimpleJavaRuntimeModule());
	}
	
	public void register(Injector injector) {
	if (!EPackage.Registry.INSTANCE.containsKey("http://www.xtext.org/example/SimpleJava")) {
		EPackage.Registry.INSTANCE.put("http://www.xtext.org/example/SimpleJava", org.xtext.example.simpleJava.SimpleJavaPackage.eINSTANCE);
	}
