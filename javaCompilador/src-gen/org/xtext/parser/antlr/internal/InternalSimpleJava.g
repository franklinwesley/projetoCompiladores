...
(
		lv_nomeContrutor_3_0=RULE_IDENTIFIER
		{
...
rulemais_aux
    ...
    { 
        $current = $this_expression_35.current; 
        afterParserOrEnumRuleCall();
    }
)
    |(	otherlv_36='?' 
    ...
    { 
        $current = $this_expression_37.current; 
        afterParserOrEnumRuleCall();
    }
	otherlv_38=':' 
    {
...
(
    ...
    { 
        $current = $this_expression_46.current; 
        afterParserOrEnumRuleCall();
    }
)
    |((	otherlv_47='>>=' 
    ...
    { 
        $current = $this_expression_51.current; 
        afterParserOrEnumRuleCall();
    }
)))(
(
