 ...
 * <ul>
 *   <li>{@link org.xtext.simpleJava.creating_expression#getNovoObjeto <em>Novo Objeto</em>}</li>
 *   <li>{@link org.xtext.simpleJava.creating_expression#getParametros <em>Parametros</em>}</li>
 *   <li>{@link org.xtext.simpleJava.creating_expression#getTipoObjeto <em>Tipo Objeto</em>}</li>
 *   <li>{@link org.xtext.simpleJava.creating_expression#getExpressaoNew <em>Expressao New</em>}</li>
 *   <li>{@link org.xtext.simpleJava.creating_expression#getNovo <em>Novo</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.simpleJava.SimpleJavaPackage#getcreating_expression()
 * @model
 * @generated
 */
public interface creating_expression extends EObject
{
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getcreating_expression_NovoObjeto()
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.creating_expression#getNovoObjeto <em>Novo Objeto</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getcreating_expression_Parametros()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.creating_expression#getParametros <em>Parametros</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getcreating_expression_TipoObjeto()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.creating_expression#getTipoObjeto <em>Tipo Objeto</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getcreating_expression_ExpressaoNew()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.creating_expression#getExpressaoNew <em>Expressao New</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
