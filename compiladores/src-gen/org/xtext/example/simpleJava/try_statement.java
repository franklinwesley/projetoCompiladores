 ...
 * <ul>
 *   <li>{@link org.xtext.example.simpleJava.try_statement#getBlocoTry <em>Bloco Try</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.try_statement#getParametroCatch <em>Parametro Catch</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.try_statement#getBlocoCatch <em>Bloco Catch</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.try_statement#getBlocoFinally <em>Bloco Finally</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.simpleJava.SimpleJavaPackage#gettry_statement()
 * @model
 * @generated
 */
public interface try_statement extends EObject
{
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#gettry_statement_BlocoTry()
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.try_statement#getBlocoTry <em>Bloco Try</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#gettry_statement_ParametroCatch()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.try_statement#getParametroCatch <em>Parametro Catch</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#gettry_statement_BlocoCatch()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.try_statement#getBlocoCatch <em>Bloco Catch</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#gettry_statement_BlocoFinally()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.try_statement#getBlocoFinally <em>Bloco Finally</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
