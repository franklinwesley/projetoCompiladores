 ...
 * <ul>
 *   <li>{@link org.xtext.example.simpleJava.impl.numeric_expressionImpl#getOperador <em>Operador</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.impl.numeric_expressionImpl#getExpressao <em>Expressao</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class numeric_expressionImpl extends MinimalEObjectImpl.Container implements numeric_expression
{
  ...
  {
    return SimpleJavaPackage.Literals.NUMERIC_EXPRESSION;
  }
  ...
  public void setOperador(String newOperador)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.NUMERIC_EXPRESSION__OPERADOR, oldOperador, operador));
  }
  ...
  public NotificationChain basicSetExpressao(expression newExpressao, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.NUMERIC_EXPRESSION__EXPRESSAO, oldExpressao, newExpressao);
  ...
  public void setExpressao(expression newExpressao)
  {
    if (newExpressao != expressao)
    {
      ...
      if (expressao != null)
        msgs = ((InternalEObject)expressao).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SimpleJavaPackage.NUMERIC_EXPRESSION__EXPRESSAO, null, msgs);
      if (newExpressao != null)
        msgs = ((InternalEObject)newExpressao).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SimpleJavaPackage.NUMERIC_EXPRESSION__EXPRESSAO, null, msgs);
      msgs = basicSetExpressao(newExpressao, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SimpleJavaPackage.NUMERIC_EXPRESSION__EXPRESSAO, newExpressao, newExpressao));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SimpleJavaPackage.NUMERIC_EXPRESSION__EXPRESSAO:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SimpleJavaPackage.NUMERIC_EXPRESSION__OPERADOR:
        return getOperador();
      case SimpleJavaPackage.NUMERIC_EXPRESSION__EXPRESSAO:
        return getExpressao();
    }
