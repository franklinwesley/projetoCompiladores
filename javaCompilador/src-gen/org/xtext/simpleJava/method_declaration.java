 ...
 * <ul>
 *   <li>{@link org.xtext.simpleJava.method_declaration#getModificadorMetodo <em>Modificador Metodo</em>}</li>
 *   <li>{@link org.xtext.simpleJava.method_declaration#getTipoRetorno <em>Tipo Retorno</em>}</li>
 *   <li>{@link org.xtext.simpleJava.method_declaration#getNomeMetodo <em>Nome Metodo</em>}</li>
 *   <li>{@link org.xtext.simpleJava.method_declaration#getParametrosMetodo <em>Parametros Metodo</em>}</li>
 *   <li>{@link org.xtext.simpleJava.method_declaration#getBlocoMetodo <em>Bloco Metodo</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.simpleJava.SimpleJavaPackage#getmethod_declaration()
 * @model
 * @generated
 */
public interface method_declaration extends EObject
{
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getmethod_declaration_ModificadorMetodo()
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.method_declaration#getModificadorMetodo <em>Modificador Metodo</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getmethod_declaration_TipoRetorno()
   * @model containment="true"
   * @generated
   */
  type getTipoRetorno();
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.method_declaration#getTipoRetorno <em>Tipo Retorno</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getmethod_declaration_NomeMetodo()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.method_declaration#getNomeMetodo <em>Nome Metodo</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getmethod_declaration_ParametrosMetodo()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.method_declaration#getParametrosMetodo <em>Parametros Metodo</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getmethod_declaration_BlocoMetodo()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.method_declaration#getBlocoMetodo <em>Bloco Metodo</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
