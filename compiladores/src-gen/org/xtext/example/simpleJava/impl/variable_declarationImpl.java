 ...
 * <ul>
 *   <li>{@link org.xtext.example.simpleJava.impl.variable_declarationImpl#getModificador <em>Modificador</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.impl.variable_declarationImpl#getTipoVariavel <em>Tipo Variavel</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.impl.variable_declarationImpl#getDeclaracaoVariaveis <em>Declaracao Variaveis</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.impl.variable_declarationImpl#getBlocoVariavel <em>Bloco Variavel</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
