 ...
 * <ul>
 *   <li>{@link org.xtext.simpleJava.for_statement#getDeclaracaoVariavel <em>Declaracao Variavel</em>}</li>
 *   <li>{@link org.xtext.simpleJava.for_statement#getExpressaoDeclaracao <em>Expressao Declaracao</em>}</li>
 *   <li>{@link org.xtext.simpleJava.for_statement#getExpressaoFor <em>Expressao For</em>}</li>
 *   <li>{@link org.xtext.simpleJava.for_statement#getExpressaoIncremento <em>Expressao Incremento</em>}</li>
 *   <li>{@link org.xtext.simpleJava.for_statement#getBlocoFor <em>Bloco For</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.simpleJava.SimpleJavaPackage#getfor_statement()
 * @model
 * @generated
 */
public interface for_statement extends EObject
{
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getfor_statement_DeclaracaoVariavel()
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.for_statement#getDeclaracaoVariavel <em>Declaracao Variavel</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getfor_statement_ExpressaoDeclaracao()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.for_statement#getExpressaoDeclaracao <em>Expressao Declaracao</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getfor_statement_ExpressaoFor()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.for_statement#getExpressaoFor <em>Expressao For</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getfor_statement_ExpressaoIncremento()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.for_statement#getExpressaoIncremento <em>Expressao Incremento</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.simpleJava.SimpleJavaPackage#getfor_statement_BlocoFor()
   * @model containment="true"
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.simpleJava.for_statement#getBlocoFor <em>Bloco For</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
