 ...
 * <ul>
 *   <li>{@link org.xtext.example.simpleJava.class_declaration#getModificadores <em>Modificadores</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.class_declaration#getNomeClasse <em>Nome Classe</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.class_declaration#getSuperclasse <em>Superclasse</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.class_declaration#getImplementosClasse <em>Implementos Classe</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.class_declaration#getCorpoClasse <em>Corpo Classe</em>}</li>
 *   <li>{@link org.xtext.example.simpleJava.class_declaration#getDeclaracaoClasse <em>Declaracao Classe</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.xtext.example.simpleJava.SimpleJavaPackage#getclass_declaration()
 * @model
 * @generated
 */
public interface class_declaration extends EObject
{
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getclass_declaration_Modificadores()
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getclass_declaration_NomeClasse()
   * @model
   * @generated
   */
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.class_declaration#getNomeClasse <em>Nome Classe</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getclass_declaration_Superclasse()
   * @model containment="true"
   * @generated
   */
  name getSuperclasse();
  ...
  /**
   * Sets the value of the '{@link org.xtext.example.simpleJava.class_declaration#getSuperclasse <em>Superclasse</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
   ...
   * @see org.xtext.example.simpleJava.SimpleJavaPackage#getclass_declaration_ImplementosClasse()
   * @model containment="true"
   * @generated
   */
